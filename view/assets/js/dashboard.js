...
(function() {
    ...
    window.reviewPendingTickets = function() {
        showSection('tickets');
    ...
    window.loadAllActivity = function(page = 1, limit = 5) {
    ...
    window.exportActivityData = function() {
    ...
    window.cleanupDashboard = function() {
        ...
        if (activityModal) {
            ...
            if (activityModal.parentNode) {
                activityModal.parentNode.removeChild(activityModal);
            }
            activityModal = null;
        }

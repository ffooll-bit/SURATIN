...
(function() {
    ...
    window.initializeTickets = function() {
        ...
        if (typeof registerGlobalFunction === 'function') {
            ...
            registerGlobalFunction('toggleSelectAll');
            registerGlobalFunction('toggleTicketSelection');
            registerGlobalFunction('updateBulkActions');
            registerGlobalFunction('showTicketDetail');
            registerGlobalFunction('showCreateTicketModal');
            registerGlobalFunction('updateTicketStatus');
            registerGlobalFunction('deleteTicket');
            registerGlobalFunction('bulkUpdateStatus');
            registerGlobalFunction('bulkDelete');
            registerGlobalFunction('exportTickets');
            registerGlobalFunction('changePage');
            registerGlobalFunction('clearFilters');
            registerGlobalFunction('refreshTickets');
        }
    ...
    window.cleanupTickets = function() {
    ...
    window.showCreateTicketModal = function() {
    ...
    window.saveTicket = function() {
        ...
        fetch('controller/api/tickets.php', {
            method: 'POST',
            headers: {
    ...
    window.updateTicketStatus = function(ticketId, newStatus) {
        ...
        fetch(`controller/api/tickets.php?id=${ticketId}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    // Export functions
    window.exportTickets = function(format) {
